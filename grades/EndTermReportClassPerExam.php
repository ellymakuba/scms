...
function set_calendar_vars($calendar_id,$subject_id,$student_id,$period,$exam_mode,$db) {
	$this->calendar_id = $calendar_id;
}
	...
	function set_calendar_vars($calendar_id,$subject_id,$student_id,$period,$exam_mode,$db)
	 {
		...
		$this->exam_marks = tep_get_status_amount($exam_mode, $this->calendar_id,$subject_id,$student_id,$period,$db);
	}
