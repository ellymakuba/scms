...
function transcript_tep_get_status($db) {
...
function transcript_tep_get_status_amount($marking_period_id, $calendar_id,$db) {
...
function transcript_course($id,$db) {
...
function transcript_set_calendar_vars($calendar_id,$db) {
...
function transcript_subject($id,$db) {
...
function transcript_set_calendar_vars($calendar_id,$db) {
 ...
 class transcript_scheduled extends transcript_subject {
	var $calendar_id;
	var $start_date;
	var $status;
	...
	function transcript_scheduled($id,$db) {
		$this->transcript_subject($id,$db);
	}
	...
	function transcript_set_calendar_vars($calendar_id,$db) {
		...
		foreach ($status_array as $r=>$s) {
			$this->status[] = array("id" => $s['id'],
								   ...
								   "marks" => transcript_tep_get_status_amount($s['id'], $this->calendar_id,$db));
		}
	}

}
class transcript_bus_report {
	...
	function transcript_bus_report($student,$period, $db) {
